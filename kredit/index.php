...
$APPLICATION->SetPageProperty("description", "Как оформить кредит в интернет-магазине Полимер");
...
<h2 style="text-align: center">Подать звявку на кредит.</h2>
<p>
</p>
<p>
</p>
<table style="max-width: 500px;margin: 0 auto;text-align: center;">
<tbody>
<tr>
	<td>
