...
?><div class="at__block-about cl">
	...
	<div class="col-about">
		<p class="about">
			 ООО «Полимер» более 20 лет на рынке, и в настоящее время является одной из крупнейших компаний оптово-розничной торговли материалами и оборудованием для отопления и водоснабжения в Воронежской области.
		</p>
		<p>
...
<div class="col-maig">
	<div class="title voa">
				...
				<div class="txt">
					 шлагбаумы, комплектующие для откатных ворот, рольставни, ворота, автоматика для ворот и др.
				</div>
			</div>
		</div>
