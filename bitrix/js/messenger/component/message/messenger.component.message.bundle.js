	...
	BX.Vue.component('bx-messenger-message', {
	  ...
	  computed: {
	    ...
	    localize: function localize() {
	      var localize = BX.Vue.getFilteredPhrases('IM_MESSENGER_MESSAGE_', this.$root.$bitrixMessages);
	    ...
	    userData: function userData() {
	      ...
	      if (typeof this.$store.state[MessengerStore.users].collection[this.message.authorId] !== 'undefined') {
	        ...
	        result = BX.Messenger.Model.Users.getUserBlank({
	          defaultName: this.localize.IM_MESSENGER_MESSAGE_USER_ANONYM
	        });
	      }
...
//# sourceMappingURL=messenger.component.message.bundle.js.map
