	...
	BX.Vue.component('bx-messenger-textarea', {
	  ...
	  directives: {
	    'bx-im-focus': {
	      inserted: function inserted(element, params) {
	        if (params.value === true || params.value === null && !BX.Messenger.Utils.device.isMobile()) {
	          element.focus();
	        }
	      }
	    }
	  ...
	  methods: {
	    ...
	    onKeyDown: function onKeyDown(event) {
	      ...
	      var text = textarea.value.trim();
	      var isMac = BX.Messenger.Utils.platform.isMac();
	      var isCtrlTEnable = BX.Messenger.Utils.platform.isBitrixDesktop() || !BX.Messenger.Utils.browser.isChrome(); // TODO see more im/install/js/im/im.js:12324
	      ...
	      if (event.keyCode == 9) {
	        ...
	        if (BX.Messenger.Utils.device.isMobile()) ; else if (this.sendByEnter == true) {
...
//# sourceMappingURL=messenger.component.textarea.bundle.js.map
