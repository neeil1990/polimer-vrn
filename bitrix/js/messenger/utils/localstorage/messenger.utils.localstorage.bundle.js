(function (exports) {
	...
	if (typeof window.BX.Messenger.LocalStorage == 'undefined') {
	  BX.Messenger.LocalStorage = new LocalStorage();
	}

}((this.window = this.window || {})));
//# sourceMappingURL=messenger.utils.localstorage.bundle.js.map
