    ...
    template: `
        ...
        <table class='table table-row-bordered table-striped table-row-gray-200 align-middle gs-7 gy-4' id='basic-1'>
            ...
            <tr class='fw-bold text-muted bg-light'>
                ...
                <th class='min-w-100px'>
                    {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_ORDER_LIST_TABLE_HEAD_WAREHOUSE') }}
                </th>
                <th class='min-w-100px'>
                    {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_ORDER_LIST_TABLE_HEAD_DELIVERY') }}
                </th>
                <th class='min-w-100px'>
                    {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_ORDER_LIST_TABLE_HEAD_SHIPMENT_DATE') }}
                </th>
            </tr>
            </thead>
            <tbody>
