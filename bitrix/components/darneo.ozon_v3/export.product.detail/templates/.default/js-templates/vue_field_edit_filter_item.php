        ...
        <div v-show='typeProperty.length > 0' class='prop-compare'>
            <template v-if='isTypeString(typeProperty)'>
                    <span class='field-title'>
                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRODUCT_DETAIL_VALUE_STRING') }}
                    </span>
                <div class='row'>
                    <div class='col-md-12'>
                        <darneo-ozon-select
            ...
            <template v-if='isTypeNumber(typeProperty)'>
                    <span class='field-title'>
                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRODUCT_DETAIL_VALUE_INT') }}
                    </span>
                <div class='row'>
                    <div class='col-md-12'>
                        <darneo-ozon-select
            ...
            <template v-if='isTypeEnum(typeProperty)'>
                    <span class='field-title'>
                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRODUCT_DETAIL_VALUE_LIST') }}
                    </span>
                <div class='row'>
                    <div class='col-md-12'>
                        <darneo-ozon-select
            ...
            <template v-if='isTypeElement(typeProperty)'>
                <span class='field-title'>
                    {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRODUCT_DETAIL_VALUE_ELEMENT') }}
                </span>
                <div class='row'>
                    <div class='col-md-12'>
                        <darneo-ozon-select
