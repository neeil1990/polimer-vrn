...
BX.BitrixVue.component('ozon-field', {
    ...
    methods: {
        ...
        isEditTypeMultiselect: type => type === 'multiselect',
        isEditTypeFilter: type => type === 'filter',
    ...
    template: `
        ...
        <div class='detail-product--trigger field-title'>
            <span>
                ...
                <span v-if='field.HELPER_TEXT.length' v-bind:data-hint='field.HELPER_TEXT'></span>
            </span>
        </div>
        <div v-if='!isShowEdit'>
        ...
        <template v-if='isShowEdit'>
            ...
            <template v-if='isEditTypeMultiselect(type)'>
                <ozon-field-edit-select
                    v-bind:data='field.EDIT'
                    v-bind:code='field.CODE'
            ...
            <template v-if='isEditTypeFilter(type)'>
                <ozon-field-edit-filter
                    v-bind:data='field.EDIT'
                    v-bind:code='field.CODE'
                    v-on:actionUpdateField='actionUpdateField'
                    v-on:showBlock='showBlock'
