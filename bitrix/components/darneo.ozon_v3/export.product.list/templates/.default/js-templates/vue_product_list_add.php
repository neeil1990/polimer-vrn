...
BX.BitrixVue.component('ozon-product-list-add', {
    ...
    template: `
        ...
        <a href='javascript:void(0)' class='btn btn-sm btn-primary' data-bs-toggle='modal' data-bs-target='#kt_modal_1'>
            {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRODUCT_LIST_BUTTON_ADD') }}
        </a>
        <div class='modal' tabindex='-1' role='dialog' id='kt_modal_1'>
            <div class='modal-dialog modal-dialog-centered' role='document'>
                <div class='modal-content'>
                    <div class='modal-header'>
                        <h5 class='modal-title' v-html='loc.DARNEO_OZON_VUE_PRODUCT_LIST_FORM_ADD'></h5>
                        <button class='btn-close' type='button' data-bs-dismiss='modal' aria-label='Close'></button>
                    </div>
                    <div class='modal-body'>
                        <div class='mb-5'>
                            <label class='form-label' v-html='loc.DARNEO_OZON_VUE_PRODUCT_LIST_PLACEHOLDER_INPUT_VALUE'></label>
                            <input class='form-control' type='text' v-model='name'>
                        </div>
                        <div class='mb-5'>
                            <label class='form-label' v-html='loc.DARNEO_OZON_VUE_PRODUCT_LIST_PLACEHOLDER_IBLOCK'></label>
                            <div class='d-flex'>
                                <div class='w-100'>
                                    <darneo-ozon-select
                                        v-bind:options='getValues(iblock)'
                                        v-bind:value='iblockId'
                                        v-bind:placeholder='loc.DARNEO_OZON_VUE_PRODUCT_LIST_PLACEHOLDER_SELECT_IBLOCK'
                    ...
                    <div class='modal-footer'>
                        <a href='javascript:void(0)' class='btn btn-light' data-bs-dismiss='modal'>
                            {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_PRODUCT_LIST_BUTTON_CANCEL') }}
                        </a>
