...
$signer = new Signer();
try {
    $params = $signer->unsign($request->get('signedParamsString'), 'darneo.ozon.export.product.attribute');
...
switch ($request->get('action')) {
    ...
    case 'list':
        ...
        break;
    case 'bindProperty':
        $params['ACTION'] = 'bindProperty';
        break;
    case 'bindConnectionEnum':
        $params['ACTION'] = 'bindConnectionEnum';
        break;
    case 'deleteConnectionEnum':
        $params['ACTION'] = 'deleteConnectionEnum';
        break;
    case 'search':
        $params['ACTION'] = 'search';
        break;
    case 'bindRatio':
        $params['ACTION'] = 'bindRatio';
        break;
    default:
        exit();
}
...
$result = $APPLICATION->IncludeComponent(
    'darneo.ozon_v3:export.product.attribute',
    '',
    $params
);
