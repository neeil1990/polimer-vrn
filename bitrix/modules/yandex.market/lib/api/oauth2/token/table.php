...
class Table extends Market\Reference\Storage\Table
{
	...
	public static function getMap()
	{
		return [
			...
			new Main\Entity\StringField('CLIENT_ID', [
				'required' => true
			]),
			new Main\Entity\StringField('USER_ID', [
				'required' => true,
			]),
			new Main\Entity\StringField('USER_LOGIN'),
			...
			new Main\Entity\IntegerField('REFRESH_COUNT', [
				'default' => 0
			]),
			new Main\Entity\StringField('REFRESH_MESSAGE')
		];
	}
}
