...
class PriceTmpTable extends Data\DataManager
{
    ...
    {
        if (self::$tablePrefix) {
            return 'darneo_ozon_export_price_tmp_' . self::$tablePrefix;
        }
        return 'darneo_ozon_export_price_tmp';
    }
    ...
    public static function setTablePrefix(string $tablePrefix): void
    {
        ...
        if ($tablePrefix) {
            ...
            $tableName = 'darneo_ozon_export_price_tmp_' . self::$tablePrefix;
