...
class ProductFilterTable extends Data\DataManager
{
    ...
    {
        if (self::$tablePrefix) {
            return 'darneo_ozon_export_product_filter_' . self::$tablePrefix;
        }
        return 'darneo_ozon_export_product_filter';
    }
    ...
    public static function setTablePrefix(string $tablePrefix): void
    {
        ...
        if ($tablePrefix) {
            ...
            $tableName = 'darneo_ozon_export_product_filter_' . self::$tablePrefix;
