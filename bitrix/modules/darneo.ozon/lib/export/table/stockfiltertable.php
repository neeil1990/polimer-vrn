...
class StockFilterTable extends Data\DataManager
{
    ...
    {
        if (self::$tablePrefix) {
            return 'darneo_ozon_export_stock_filter_' . self::$tablePrefix;
        }
        return 'darneo_ozon_export_stock_filter';
    }
    ...
    public static function setTablePrefix(string $tablePrefix): void
    {
        ...
        if ($tablePrefix) {
            ...
            $tableName = 'darneo_ozon_export_stock_filter_' . self::$tablePrefix;
