...
const SETTING_CODE = 'IMPORT_ANALYTIC';
...
if ($update->isSuccess()) {
    (new \Darneo\Ozon\Analytics\Import\Sale())->init();
    (new Darneo\Ozon\Order\Fbs\Cron\Manager())->start();
    (new Darneo\Ozon\Order\Fbo\Cron\Manager())->start();
}
