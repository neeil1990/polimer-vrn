...
BX.BitrixVue.component('ozon-product-list-item', {
    ...
    template: `
        ...
        <td v-html='item.STORE_SHOP'></td>
        <td v-html='item.OZON_STOCK_NAME'></td>
        <td v-html='item.MIN_COUNT_STORE'></td>
        <td v-html='item.MAX_COUNT_STORE'></td>
        <td>
        ...
        <td>
            ...
            <a href='javascript:void(0)' class='btn btn-icon btn-bg-light btn-active-color-primary btn-sm mb-1'
