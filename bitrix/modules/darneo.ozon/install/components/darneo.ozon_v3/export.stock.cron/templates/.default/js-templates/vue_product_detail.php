    ...
    template: `
            ...
            <div class='card card-stretch'>
                <div class='card-body'>
                    <div class='detail-cron--trigger field-title'>
                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_STOCK_CRON_TASK_TITLE') }}
                    </div>
        ...
        <div class='col-lg-12' v-if='!data.GENERAL_ACTIVE'>
            <div class='alert alert-danger d-flex align-items-center p-5 mt-2 mb-2'>
                ...
                <div class='d-flex flex-column'>
                    <h4 class='mb-1 text-danger'>{{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_STOCK_CRON_GENERAL_ACTIVE_WARNING_H1') }}</h4>
                    <span>
                        {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_STOCK_CRON_GENERAL_ACTIVE_WARNING') }}
                        <a v-bind:href='data.SETTING_CRON_FOLDER' class='btn btn-primary ms-5'>
                            {{ $Bitrix.Loc.getMessage('DARNEO_OZON_VUE_STOCK_CRON_GENERAL_ACTIVE_BUTTON') }}
                        </a>
                    </span>
                </div>
            </div>
