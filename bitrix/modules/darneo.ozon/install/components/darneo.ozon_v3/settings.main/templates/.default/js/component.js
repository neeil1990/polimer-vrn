(function () {
    ...
    BX.namespace('BX.Ozon.SettingsMain.Vue')

    BX.Ozon.SettingsMain.Vue = {
            ...
            BX.BitrixVue.createApp({
                ...
                methods: {
                    actionUpdateField: function (dataForm) {
                        let data = dataForm
                        data['action'] = 'update'
                        BX.Ozon.SettingsMain.Vue.sendRequest(data)
                    },
                ...
                template: `
                    <div>
                        ...
                        <product-modal 
                            ...
                            v-bind:title='loc.DARNEO_OZON_VUE_SETTINGS_MAIN_WARNING'
                        />
                    </div>
                `
            })
