...
class CBitrixXscanAjax
{
    ...
    private static function scan(CBitrixXscanFork $scaner, $nav, $start_path, $break_point='', $clean=false)
    {
    ...
    public static function run($scaner, $nav, $start_path, $break_point, $clean)
    {
        ...
        elseif ($action == 'scan'){
            $response = self::scan($scaner, $nav, $start_path, $break_point, $clean);
        }
