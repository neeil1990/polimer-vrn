...
class CBitrixXscanFork
{
    ...
    public $false_positives = ['b4cd0dcca178dbc12935e505860864ad', 'f9577fd4ffb4024a8b1c7a63247e52e7', 'cc6969f6a56325d5676bc02a268057f8',
        ...
        '463ce09267c3c966dda3144aa3ef75d4', 'fc81ad62d76829d50e02ca8abc896480', 'bb51a75da5892416d8a38da7243380c1', 'd5dba8705b9ebb4f75341e2e414cd716',
        '84b7402558c54c12e0aea8510dd0bc77', 'b83abde34a9dbd8df8bff2bd40eed956', 'ab12d401c18b0a875e42b68c5a681bc0', '1343333aba4c03bbdad6e70843dbe674',
        '08e50254e531e3914b91242c23b4ccb6', '6d99e9dfff75ec06a503d2746b5369a1', '657f556b4a7b46116d49f439357dd4b1', 'cd2b8f7c9bf2e91999865bb6c3423dc1',
        '6fdb1d06b32a6f877b41d81dc025264c', 'f88fe14268d4d8573407ffc1e7541e09', 'ac3d0161ee569afd32ddb61010dafa02', '31f1ee6b18b9ca10b75777eed87ea550',
        'd40c4da27ce1860c111fc0e68a4b39b5', 'ef9287187dc22a6ce47476fd80720878', '13484affcdf9f45d29b61d732f8a5855', 'a42085898510d273060860dc5d061e7d',
        'de92235803864f49ffe2acd6895614bd', '7bdf36fda00293e9e180e5fceb35e154', '975195eb1de3006e339d316b1b97b8e7', 'b9fd835457a3a6200c41fe09ee28a2a5',
        '7c60ccaee2b919c9e6b16b307eb80dab', '77cdd8164d4940cb6bfaac906383a766', '5b3425a6ff518fa2337b373e1c799959', '00bbf12c4dbcd93c1fd28a1bfed674e7',
        '531faf615932968b15900ebaf5347649', 'b87864a824944eb16289243e99cb50bb', '57caa63b942f7a6bd841108a741a1a20', '7cabe148672e855b5d766bd8baeafc69',
        'dac7d1407715e1710e920881b14a30e0', 'a9158139e1a619ca8cc320cf4469c250'];
...
//    }
    ...
    {
//        $rp = realpath($file_path);
//        if ($this->doc_root && strpos($file_path, $this->doc_root) === 0) {
//            $file_path = substr($file_path, strlen($this->doc_root));
//        } elseif ($this->doc_root && strpos($rp, $this->doc_root) === 0) {
//            $file_path = substr($rp, strlen($this->doc_root));
...
//        }
    ...
    private function CheckCodeInternal(&$src, $file_path = false)
    {
        ...
        if (
            ...
            if (in_array($cmt, ['$$', 'vars', 'goto', 'globals', 'base64_short'])) {
...
//        print_r($arg);
        ...
        if (!$ret && $config['value']) {
            ...
            if ($config['recursive']) {
                ...
                if ($res) {
                    list($ret, $comment) = [true, 'recursive'];
                }
                unset($subscan);
            } else {
