...
if (!CModule::IncludeModule('step2use.uniteller')) {
	return;
}

require_once($_SERVER['DOCUMENT_ROOT'] . '/bitrix/modules/step2use.uniteller/include.php'); // инициализация модуля
require_once($_SERVER['DOCUMENT_ROOT'] . '/bitrix/modules/step2use.uniteller/prolog.php'); // пролог модуля

// получим права доступа текущего пользователя на модуль
$POST_RIGHT = $APPLICATION->GetGroupRight('step2use.uniteller');
...
$arMenu = array(
	array(
		...
		'LINK' => '/bitrix/admin/settings.php?lang=' . LANGUAGE_ID . '&mid=step2use.uniteller&mid_menu=1',
		'ICON' => 'btn_update_log',
	),
);
