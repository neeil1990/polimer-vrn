...
global $MESS;
$MESS['ATL_U_MODULE_PARTNER'] = 'Атлант - комплексное сопровождение и развитие магазинов на 1С-Битрикс';  

// step2use.uniteller/install/index.php
$MESS['UNITELLER.SALE_INSTALL_NAME'] = 'Платёжная система Uniteller';
$MESS['UNITELLER.SALE_INSTALL_DESCRIPTION'] = 'Компания Юнителлер предлагает Вам решения в области интернет эквайринга и процессинга электронных платежей:
интернет эквайринг – подключение оплаты банковскими картами через интернет на Вашем сайте. Гибкие тарифы эквайринга;
эквайринг в самообслуживании – подключение приема пластиковых карт в платежных киосках, терминалах приема платежей, парковках (паркоматах), терминалах по продаже билетов, вендинговых автоматах. Интеграция с программным обеспечением терминалов;
электронные деньги - подключение приема платежей через интернет всеми видами электронных валют.
Безопасность и надежность платежей банковскими картами через процессинг Uniteller подтверждена сертификатом соответствия стандарту PCI DSS версии 3.1.';
...
<div>&nbsp;&nbsp;2. При удалении модуля останется папка с пакетом установщика «папка_с_bitrix/bitrix/modules/step2use.uniteller», все остальные файлы будут удалены.</div>
</p>
