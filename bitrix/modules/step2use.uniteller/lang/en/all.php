...
global $MESS;
// step2use.unitellere/install/index.php

$MESS['ATL_U_MODULE_PARTNER'] = 'Atlant- complex support and development of stores 1C - Bitrix';  
$MESS['UNITELLER.SALE_INSTALL_NAME'] = '«Uniteller payment system»';
$MESS['UNITELLER.SALE_INSTALL_DESCRIPTION'] = 'Description of the «Uniteller payment system» module <a href="/bitrix/admin/settings.php?lang=en&mid=step2use.uniteller&mid_menu=1" target="_blank">Go to the Help page</a>';
...
// step2use.uniteller/options.php & step2use.uniteller/install/step_ok.php & step2use.uniteller/admin/uniteller_agent_log.php
...
// step2use.uniteller/options.php
...
<div>&nbsp;&nbsp;2. If the module is removed, «Folder_with_bitrix/bitrix/modules/step2use.uniteller» folder with the installation package will be kept in the system. All other files will be removed.</div>
</p>
