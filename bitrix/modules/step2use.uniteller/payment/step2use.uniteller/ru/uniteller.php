...
$MESS['SALE_UNITELLER_INCLUDE_DELIVERY'] = "Включать стоимость доставки в чек (Y/N)";
...
$MESS['SALE_UNITELLER_DELIVERY_VAT'] = "Ставка НДС для доставки (%)";
$MESS['SALE_UNITELLER_DELIVERY_VAT_DESC'] = 'Какую ставку НДС использовать для доставки если стоимость доставки включается в чек.';
