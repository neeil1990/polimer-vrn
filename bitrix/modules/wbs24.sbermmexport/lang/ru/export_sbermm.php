...
$MESS["YANDEX_PROP_picture"] = "Дополнительные фото (для товаров)";
$MESS["YANDEX_PROP_offers-picture"] = "Дополнительные фото (для ТП)";
...
$MESS["YANDEX_PROP_barcode"] = "Штрихкод";
$MESS["YANDEX_PROP_order-before"] = "Время окончания операционного дня";
$MESS["YANDEX_PROP_days"] = "Кол-во рабочих дней для отгрузки заказа";
...
$MESS["YANDEX_PROPS_SHIPMENT"] = "Настройка параметров отгрузки товара";
$MESS["YANDEX_PRICES"] = "Цены";
$MESS["YANDEX_PRICE_TYPE"] = "Использовать (выводить) цену";
$MESS["YANDEX_PRICE_TYPE_NONE"] = "оптимальную (самую низкую)";
...
$MESS["YANDEX_VAT_ATTENTION"] = "Внимание! Если необходимая ставка НДС отсутсвует, то <a href='/bitrix/admin/cat_vat_admin.php?lang=ru' target='_blank'>вы можете добавить ее в настройках магазина</a>";
