...
$MESS["MAIL_CLIENT_CONFIG_ACCESS_HINT_MSGVER_1"] = "Дозвольте іншим працівникам отримувати листи з цієї скриньки та відповідати на них. Додайте потрібних співробітників та організуйте спільну роботу з поштою, наприклад, для відділу продажів або служби підтримки клієнтів.";
...
$MESS["MAIL_CLIENT_CONFIG_EMAIL_OAUTH_FIELD_ERROR"] = "Неправильна адреса електронної пошти. Уведіть адресу електронної пошти, яка прив’язана до вибраного облікового запису.";
$MESS["MAIL_CLIENT_CONFIG_EMAIL_OAUTH_FIELD_SUCCESS"] = "Адресу електронної пошти підтверджено!";
$MESS["MAIL_CLIENT_CONFIG_EMAIL_OAUTH_FIELD_TITLE_OFFICE365"] = "Необхідно ввести адресу електронної пошти вручну (згідно з правилами безпеки Microsoft inc.)";
