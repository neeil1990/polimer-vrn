<? /**
 *
 * Ўаблон NewsArticle в формате даных Microdata
 *
 * ¬ходной массив
 * @var array
 */
...
?><div data-module=zverushki_microm itemscope itemtype="http://schema.org/NewsArticle" style="display:none"><?
...
if ($result['picture']):
	?><div itemprop="image" itemscope itemtype="https://schema.org/ImageObject"><?
		?><link itemprop="contentUrl" href="<?=$domen.$Server->getServerName().$result['picture']['src'];?>"><?
		?><link itemprop="url" href="<?=$domen.$Server->getServerName().$result['picture']['src'];?>"><?
...
if ($result['dateline']):
	?><meta itemprop="dateline" content="<?=$result['dateline'];?>"><?
endif;
...
if ($result['wordCount']):
	?><meta itemprop="wordCount" content="<?=$result['wordCount'];?>"><?
endif;
