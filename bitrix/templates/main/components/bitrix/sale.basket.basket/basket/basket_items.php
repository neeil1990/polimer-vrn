			...
			<div class="l-block">
				...
				<div class="l-row cl">
					...
					<div class="l-cell name">
						...
						<a href="<?=$arItem["DETAIL_PAGE_URL"] ?>" class="plink">
						<?endif;?>
						<?=$arItem["NAME"]?>
						<?if (strlen($arItem["DETAIL_PAGE_URL"]) > 0):?>
						</a>
					...
					<div class="l-cell price"><div class="txt pr">Цена</div>
						<span class="current_price" id="current_price_<?=$arItem["ID"]?>">
							<?=$arItem["PRICE_FORMATED"]?>
						</span>
					</div>
					<div class="l-cell sale"><div class="txt sl">Скидка</div>
					...
					<div class="l-cell quan">
						...
						<div class="quantity">
							...
							?>
							<a class="minus" href="javascript:void(0);" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'down', <?=$useFloatQuantityJS?>);"></a>
							<input
								type="text"
								...
								>
							<a class="plus" href="javascript:void(0);" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'up', <?=$useFloatQuantityJS?>);"></a>
						</div>
						<input type="hidden" id="QUANTITY_<?=$arItem['ID']?>" name="QUANTITY_<?=$arItem['ID']?>" value="<?=$arItem["QUANTITY"]?>" />
					</div>
					<div class="l-cell cost" id="<?=$arItem["ID"]?>">
						<div class="txt ct">Стоимость</div>
					...
					<div class="l-cell del"><div class="txt dl">Удалить</div><a href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"></a></div>
				</div>
